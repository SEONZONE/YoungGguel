				...
				.click(
						function() {
							if ($("input#textbox").val().length == 0) {
								...
								document.location.href = '/movie/movieSearch.do?search='
										+ $("input#textbox").val();
							}
						});
		...
		function ajaxMainList(v) {
			...
			$
					.each(
							v,
							function(index, dom) {
								temp += "<li id="+dom.movieCd+"><a href=\"/movie/movieInfo.do?no="
										+ dom.movieCd
										+ "\"><img src=\"/movie/view/img/"+dom.movieCd+".jpg\" id=\"hoverImg\"></a></li>";
								hover += "<div class=\"hoverContents\">";
								hover += "<div class=\"main_hover_con\" id="+dom.movieCd+">";
								hover += "<div class=\"hover_back\">";
								hover += "<div class=\"hover_txt\" id=\"movieNm\" style=\"font-size: 25px; font-weight: bold;\">"
										+ dom.movieNm + "</div>";
								hover += "<div class=\"hover_txt\" style=\"font-size: 17px;\">예매율<span>79%</span></div>";
								hover += "<div class=\"hover_txt\" style=\"font-size: 17px;\">"
										+ dom.genre
										+ "<span>·</span><span>"
										+ dom.showTm + "분</span></div><br><br>";
