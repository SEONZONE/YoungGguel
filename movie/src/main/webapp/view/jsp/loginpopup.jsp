...
<body>
	<div class="login_Pop_Wrapping">
		<div class="contents">
			<div class="topcon">
				<span>LOGIN</span> <img src="/movie/view/img/popupx.png">
			</div>
			<form action="">
			...
			<div class="midcon">
				<img src="/movie/view/img/loginpopupnaver.png"> <span
					...
					src="/movie/view/img/loginpopupkakao.png"><br> <span>네이버</span>
				<span>카카오</span>
			</div>
			<div class="footcon">
				<div class="findidpw">
				...
				<div class="joinuscon">
					<span style="color: #133597;">영끌이 처음이신가요?</span> <img
						src="/movie/view/img/loginpopupjoin.png">
				</div>
			</div>
		</div>
	</div>
