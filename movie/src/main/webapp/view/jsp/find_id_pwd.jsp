...
<body>
	<div class="find_Wrapping">
		<div class="find">
			<div class="contents">
				<div class="topcon">
					<span>아이디/비밀번호 찾기</span> <img src="/movie/view/img/popupx.png"
						style="position: absolute; right: 34%; cursor: pointer;">
				</div>
				<div class="find_list">
					<div class="find_btn ">아이디 찾기</div>
					<div class="find_btn off">비밀번호 찾기</div>
				</div>
				<div class="midcon_Wrapping">
					<div class="midcon">
						...
						<div class="find_id ">
							...
							<div class="mid_top">회원정보를 입력해주세요.</div>
							<br>
							<form>
								<ul class="info_list">
									<li><div>성명</div>
							...
							<form>
								<ul class="info_list">
									...
									<li><div>성명</div>
										<input type="text"></li>
									<li><div>휴대폰번호</div>
										<input type="text"><span class="phone_number_check">인증요청</span></li>
									<li><div>인증번호</div>
										<input type="text"><span class="phone_check">인증확인</span></li>
								</ul>
