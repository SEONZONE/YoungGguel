...
<body>
	...
	<div class="select_check">
		<span class="click"> <svg xmlns="http://www.w3.org/2000/svg"
		...
		</span> <span class=""> <svg xmlns="http://www.w3.org/2000/svg"
				width="16" height="16" fill="currentColor"
				class="bi bi-check-circle" viewBox="0 0 16 16">
                        <path
					d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z" />
		...
		</span> <span class="click"> <svg xmlns="http://www.w3.org/2000/svg"
				width="16" height="16" fill="currentColor"
				class="bi bi-check-circle" viewBox="0 0 16 16">
                        <path
					d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z" />
				...
				<div class="middle_field">
					...
					<div class="list">
						<ul>
							<li>
								<button type="button" class="btn">
									<span><img src="/movie/view/img/19.png">&nbsp;</span> <span>모가디슈</span>
								</button>
							</li>
							<li>
								<button type="button" class="btn">
									<span><img src="/movie/view/img/15.png">&nbsp;</span> <span>모가디슈</span>
								</button>
							</li>
							<li>
								<button type="button" class="btn">
									<span><img src="/movie/view/img/12.png">&nbsp;</span> <span>모가디슈</span>
								</button>
							</li>
							<li>
								<button type="button" class="btn">
									<span><img src="/movie/view/img/all.png">&nbsp;</span> <span>모가디슈</span>
								</button>
							</li>
						</ul>
					</div>
						...
						<ul>
							<li>
								<button type="button" class="time_btn">
									<span class="time">09:10</span> <span class="theater">역삼쌍용용죽겠지점</span>
									<span class="possible_now">10</span> <span class="all">/
										150</span>
								</button>
							</li>
							<li>
								<button type="button" class="time_btn on">
									<span class="time">09:10</span> <span class="theater">강남대로변두리점</span>
									<span class="possible_now">10</span> <span class="all">/
										150</span>
								</button>
							</li>
			...
			<div class="choice_box">
				...
				<div class="choice_seat">
					...
					<div class="seat_row_wrapping">
						<button type="button" class="seat_row"
							style="position: absolute; top: 360px; left: 150px;">A</button>
						<button type="button" class="seat_number common"
							style="position: absolute; top: 360px; left: 200px;">1</button>
						<button type="button" class="seat_number choice"
							style="position: absolute; top: 360px; left: 230px;">2</button>
						<button type="button" class="seat_number finish"
							style="position: absolute; top: 360px; left: 260px;">x</button>
					</div>
					<div class="seat_row_wrapping">
						<button type="button" class="seat_row"
							style="position: absolute; top: 390px; left: 150px;">B</button>
						<button type="button" class="seat_number common"
							style="position: absolute; top: 390px; left: 200px;">1</button>
						<button type="button" class="seat_number choice"
							style="position: absolute; top: 390px; left: 230px;">2</button>
						<button type="button" class="seat_number finish"
							style="position: absolute; top: 390px; left: 260px;">x</button>
					</div>
				</div>
			</div>
			<!-- 2번 좌측끝-->
			...
			<div class="show_box">
				...
				<div class="show_box_right">
					<div
						...
						<img src="/movie/view/img/19.png"
							style="width: 15px; margin-right: 5px;">모가디슈
					</div>
					...
					<div style="padding-bottom: 30px; color: #bdbec4; font-size: 13pt;">성인
						2인</div>
					<span style="color: #bdbec4; font-size: 13pt;">최종결제금액</span> <span
						style="color: #49addc; font-size: 13pt; font-weight: bold;">
						20000원</span>
				</div>
